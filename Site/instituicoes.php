  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="index_user.html"><img src="./img/logo3.png" width="40" style="margin-right: 5px;" alt="Logo VoluntárioCOVID19"> VoluntárioCOVID19</a>
            ...
            <div class="col px-5 pb-5">
                ...
                <script>
                    function setReceiver(array) {
                        console.log(array);
                        let name = array[0];
                        let phone = parseInt(array[1]);
                        localStorage.setItem("receiverP", phone);
                        localStorage.setItem("receiverN", name);
                        window.location.href = "chatV.php";
                    };
                </script>
                ...
                <?php
                    ...
                    <th>Freguesia</th> <th>Email</th> <th>Website</th> <th></th> </tr>';
                    ...
                    $query = "SELECT nome, descricao, telefone, morada, distrito, concelho, freguesia, mail, website FROM $tabela";
