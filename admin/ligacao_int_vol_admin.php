        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Procurar Correspondências</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <main id = "fundo_admin_v">
        ...
        <div class="row">
            <div class="col px-5 pb-5">
                ...
                <th>Nome Voluntário</th> <th>Telefone</th> <th>Email</th> <th>Area de Interesse</th> <th>População alvo</th> </tr>';




                $query = "SELECT DISTINCT av.nome_acao, vr.nome, vr.telefone, vr.mail, ai.nome, pa.nome_pop_alvo FROM accao_voluntariado av
                        ...
                        LEFT JOIN areas_interesse ai ON (alv.id_area = ai.id_area)";
